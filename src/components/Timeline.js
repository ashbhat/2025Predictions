          ...
          >
            ...
            {hoveredEvent === ev && (
              <div style={{
                position: 'absolute',
                top: '-3.5rem',
                left: getYearPercent(ev.date) < 20 ? '10px' : getYearPercent(ev.date) > 80 ? 'auto' : '50%',
                right: getYearPercent(ev.date) > 80 ? '10px' : 'auto',
                transform: getYearPercent(ev.date) < 20 || getYearPercent(ev.date) > 80 ? 'none' : 'translateX(-50%)',
