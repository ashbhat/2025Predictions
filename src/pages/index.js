    ...
    <div>
      ...
      <main className={styles.container}>
        ...
        <div className={styles.content}>
          <div className={styles.prediction} id="January">
          ...
          <div className={styles.prediction} id="February">
          ...
          <div className={styles.prediction} id="March">
          ...
          <div className={styles.prediction} id="April">
          ...
          <div className={styles.prediction} id="May">
          ...
          <div className={styles.prediction} id="June">
          ...
          <div className={styles.prediction} id="July">
          ...
          <div className={styles.prediction} id="August">
          ...
          <div className={styles.prediction} id="September">
          ...
          <div className={styles.prediction} id="October">
          ...
          <div className={styles.prediction} id="November">
          ...
          <div className={styles.prediction} id="December">
